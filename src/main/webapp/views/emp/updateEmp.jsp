    ...
    <form action="" method="post" class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5 skin-minimal">
                ...
                <div class="radio-box">
                    <input type="radio" id="sex-0" value="0" name="sex">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="${emp.mobile}" id="user-tel" name="mobile"  datatype="m" nullmsg="手机不能为空">
            </div>
            <div class="col-4"> </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="${emp.orderbyIndex}" name="orderbyIndex"  datatype="n">
            </div>
            <div class="col-4"> </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text Wdate" value="<fmt:formatDate value="${emp.birthday}" pattern="yyyy-MM-dd"/>" onclick="WdatePicker({readOnly:true,lang:'zh-cn'})" id="birthday" name="birthday"  datatype="*">
            </div>
            <div class="col-4"> </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text"  value="${emp.email}" name="email" id="email" datatype="e" nullmsg="请输入邮箱！">
            </div>
            <div class="col-4"> </div>
        </div>
